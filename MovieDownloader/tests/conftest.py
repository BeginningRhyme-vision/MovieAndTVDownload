"""Shared pytest setup for MovieDownloader offline tests.
...
_MOVIE_DIR = Path(__file__).resolve().parent.parent
if str(_MOVIE_DIR) not in sys.path:
    sys.path.insert(0, str(_MOVIE_DIR))
