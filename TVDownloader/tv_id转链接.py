...
# Movie format: <https://vidup.to/movie/{IMDB_ID or TMDB_ID}>
# Tv format: <https://vidup.to/tv/{IMDB_ID or TMDB_ID}/{season_number}/{episode_number}>
...
base_url = f"https://vidup.to/movie/1439930"
